          ...
          <section className="left-section" onSubmit={this._handleSubmit}>
            <form action="#" className='main-form'>
                <fieldset className='main-form__field'>
                    ...
                    <label >Title<input type="text" className='main-form__movie-title' value={this.state.title} onChange={this._handleTitleChange}/></label>
                    <label>Discription<textarea name="discription" cols="30" rows="10" className='main-form__movie-description' value={this.state.overview} onChange={this._handleOverviewChange}></textarea></label>
                    <label>Rating<Select handelVote={this._handleVoteChange}/></label>
